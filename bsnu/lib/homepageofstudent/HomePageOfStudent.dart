...
class HomePageOfStudent extends StatefulWidget {
  HomePageOfStudent({
    Key? key,
  }) : super(key: key);

  @override
  State<HomePageOfStudent> createState() => _HomePageOfStudentState();
}

class _HomePageOfStudentState extends State<HomePageOfStudent> {
  @override
